...
@Component({
  selector: 'app-benefit-application-calculate',
  templateUrl: './benefit-application-calculate.component.html',
  styleUrls: ['./benefit-application-calculate.component.scss']
})
export class BenefitApplicationCalculateComponent extends SharedClassComponent implements OnInit {
  ...
  calculate()
  {
    ...
    const data = {
      ...
      "requestType": "BENEFIT_APPLICATION_CALCULATION",
