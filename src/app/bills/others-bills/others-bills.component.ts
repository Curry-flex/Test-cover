...
@Component({
  selector: 'app-others-bills',
  templateUrl: './others-bills.component.html',
  styleUrls: ['./others-bills.component.scss']
})
export class OthersBillsComponent extends SharedClassComponent implements OnInit {
