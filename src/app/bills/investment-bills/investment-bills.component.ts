...
@Component({
  selector: 'app-investment-bills',
  templateUrl: './investment-bills.component.html',
  styleUrls: ['./investment-bills.component.scss']
})
export class InvestmentBillsComponent extends SharedClassComponent implements OnInit {
