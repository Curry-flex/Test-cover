...
@Component({
  selector: 'app-contributions-bills',
  templateUrl: './contributions-bills.component.html',
  styleUrls: ['./contributions-bills.component.scss']
})
export class ContributionsBillsComponent extends SharedClassComponent implements OnInit {
