...
@Component({
  selector: 'app-individual-contributors-users',
  templateUrl: './individual-contributors-users.component.html',
  styleUrls: ['./individual-contributors-users.component.scss']
})
export class IndividualContributorsUsersComponent extends SharedClassComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.fetchRequestTypes('USERS_LIST', 'INDIVIDUAL_CONTRIBUTOR');
