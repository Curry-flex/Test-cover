...
@Component({
  ...
  styleUrls: ['./investment-users.component.scss']
})
export class InvestmentUsersComponent extends SharedClassComponent implements OnInit {
  modelName = 'backend/request';
  title = 'Investment User';
  ...
  ngOnInit() {
    ...
    this.fetchRequestTypes('USERS_LIST', 'INVESTMENT');
